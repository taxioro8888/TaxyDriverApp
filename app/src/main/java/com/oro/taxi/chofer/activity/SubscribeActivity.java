...
public class SubscribeActivity extends BaseActivity {
    private Button send,i_have_account;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //i_have_account = (Button) findViewById(R.id.i_have_account);
        i_have_account=(Button)findViewById(R.id.i_have_account);
...
//                startActivity(new Intent(SubscribeActivity.this, ChoosePhotoActivity.class));
    ...
    private boolean validatePhoneValid() {
        if (phone_subs.getText().toString().trim().length() < 7) {
    ...
    private boolean validatePasswordValid() {
        if (password_subs.getText().toString().trim().length() < 5) {
