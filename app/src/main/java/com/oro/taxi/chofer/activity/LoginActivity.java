...
import com.oro.taxi.chofer.model.User;
...
public class LoginActivity extends BaseActivity {
    private TextView create_customer_account,forget_password,title;
    ...
    Button login,create_driver_account;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        create_driver_account = (Button) findViewById(R.id.create_driver_account);
        ...
        create_driver_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("account_type","chofer");
